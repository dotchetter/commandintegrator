...
class FeatureCommandParserABC(ABC):
    ...
    @abstractmethod
    def is_contender_for_processing(self, message: models.Message) -> bool:
        return
    
    @abstractmethod
    def get_callback(self, message: models.Message) -> 'function':
        return
...
class FeatureBase(FeatureABC):
    ...
    def __call__(self, message: models.Message) -> callable:
        try:
    ...
    def command_parser(self, command_parser: FeatureCommandParserBase):
        ...
        self._command_parser = command_parse